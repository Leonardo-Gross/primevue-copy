...
import AButton from '@/components/AButton.vue'; // ou use o alias @Components, se configurado corretamente
</script>
...
<template>
  <div class="h-full w-full bg-gray-100 p-10">
    ...
    <!-- Advanced Card -->
    <div class="m-5 mt-10">
      <h2 class="mb-4 text-2xl font-bold">Advanced</h2>
      <div class="justify-items-center">
        <ACard class="w-sm overflow-hidden">
          <template #header>
            <img
          ...
          <template #footer>
            <div class="mt-4 flex justify-center gap-4">
              <AButton class="w-full max-w-50" severity="secondary" label="Cancel" />
              <AButton class="w-full max-w-50" label="Save" />
            </div>
          </template>
        </ACard>
      </div>
